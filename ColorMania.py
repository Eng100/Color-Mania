...
level_two = [
            ...
            "                    CMD    B          CMMD                            CMD 3  BBB                                        BB                          BB              CMMMD      ",
...
level_four = [
        "XXXXXXXBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBXXXXXXXXXXXBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
        "X      B                                             B                             B           B                             X",
        "X      B                  1                          B                             B           B              2              X",
        "X      B  G         B     CD     CD     CD     CD    B                     CMMMMMMMM           B        CMMMMMMM   MM        X",
        "X      BMMMMD       B                                B                                         B                    B        X",
        "X      B            B                                B                                         B                    B        X",
        "X      B            B                                B      1             2             CMMMMMMMMMMMMMD             B        X",
        "X      B            B   CD        CD        CD     CMB                 CMMMMMM                                      B        X",
        "X              CMMMMB                                B                       B             1                        B        X",
        "X                   B                                B    CMMMMMMD           B        CMMMMMMMD           CMMMMMMMMMB        X",
        "X      B            B        2                       B                       B   G                                  B        X",
        "X      B            BMD     CD      CD       CD      B                       MMMMMMMMD           CMMMMMD      4     B        X",
        "X      BMMMMMMD     B                                B                                                              B        X",
        "X      B            B                                B       3                               2                      B        X",
        "X      B            B                                B                CMMMMM                CMMMMMMM      CMMMMMD   B        X",
        "X      B     CMMMMMMB   CD      CD     CD            B      CMMD           B                       B                B        X",  
        "X                   B                                                      B                       B                B        X", 
        "X    J              B                           2                          MMMMMMD        CMMMMMMMMMMMMMMMD      Y  B     2 FX",
        "LMMMMMMMMMMMMMMMMMMMMR                         LMMMMMMMMMMMMR                                                 LMMMMMMMMMMMMMMR",
        ]

level_five = [
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBBBBBBXXXXXXXXXXXXXXXXXXXXXXXX",
        "X                                                                           B                              BBBBBB                        ",
        "X                                                                           B                              BBBBBB                        ",
        "X    BBBB                                                          2       SB        BBBBBBBB  1           BB      BMMMD                 ",
        "X       B                           2                                    CMMB        BB     B  B           BB      B                     ",
        "X       B                                                                            BB     B  B           BB  BBBBB                     ",
        "X       B            P                         CMMD              CMD                 BB  B     MMD         BB    BBB             CMMMMMMM",
        "X       B           CMMD                                                             BB  B     B           BBBB  BMB                     ",
        "X     BBB                                                                            BB  BBBBBBB        B        B                       ",
        "X       B                                                                    CMD     BB       B         B H   H  B                       ",
        "X       B                 4                                                          BB       B         BBMMMMMMMMMMMMMMD                ",
        "X       B                                                                            BBBBBBB  BD        BB                               ",
        "X       B                      B                 LMR                                 BB       B         BB                               ",
        "X      BB                      B                                                   2 BB       B         BB     CD                  CMMMMM",
        "X       B                      B            3                                        BB  BBBBBB        CBB                               ",
        "X       B                                                                                     B         BB            2                  ",
        "X       B             LMR                                                 1                   B                     CMMD                 ",
        "XG      B                            B                                                      3 BG         1                              F",
        "LMMMMMMMMMM                          3 LMR              LMR      LMR           LMMMMMMMMMMMMMMMR       LMMR                       LMMMMMR",
        ]

level_six = [
        "XXXXXXBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBXXXXXXXXXXXXXXXXXXXXXXXBBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBBBXXXXXXXXXXXXXXXXXX",
        "X     B                                       B                       BB                                            BBB                  ",
        "XP    B                                      JB                       BB                                            BBB BBBBBBB          ",
        "MR  1 BS                                    BBBMMD  BBBB              BB                                                B     BBBBB      ",
        "X     BMD                                     B        B                                                            BBBBB                ",
        "X    LB          CMMD                         B        B     CMMD                  2   BBB           1              BBBMMD               ",
        "X     B                                       B                      CMMD              BBBMMMMMMMMMMMMMMMMMMMMMMD   BBB                  ",
        "MR    B                                       BMMD                                  CMMBBB                          BBB               CMM",
        "X     BMD        BBBBMMD                      B                                        BBB                          BBB                  ",
        "X    LB          BBBB                         B     3                                  BBB    CMMMMMMMMMMMMMMMMMMMMMBBB                  ",
        "X     B          BBBB                         B                                        BBB                          BBBMMMMMMMMD         ",
        "X              CMBBBB                         BMMD                                     BBB                          BBB                  ",
        "X                BBBB                         B                                        BBBMMMMMMMMMMMMMMMMMMMMMMD   BBB                  ",
        "X                BBBB                     CMMMB                CMMD       4            BBB                          BBB     CMMMMMMMMMMMM",
        "MR    BMD        BBBB                         B                                        BBB                          BBB                  ",
        "X     B          BBBB                         B                  3           CMMD      BBB   CMMMMMMMMMMMMMMMMMMD   BBB                  ",
        "X    LB          BBBB           CMMMD         B                                        BBB                            LMMMD              ",
        "X     B          BBBB                         B                                3       BBB                                               ",
...
level_seven = [
        ...
        "B          B                                                                                        B     B                                    B                                B                                       ",
        "B          B    J                                                                                   B     B                                                                     B                                       ",
        "BB   BB    B   CMR                                                                                  B  B  B  B         CD                                                       B                         CMMMMB        ",
        "B  3 BB    B   B                                                                                    B  B     B               1                      M                           B   B                          B        ",
        "B    BB    B   B                              LR                             B               B      B  B     B                                                                  B   B                          B       F",
        "B    BB    B   B                                             B                                         BBBBBBBBB                                               1                B   B                          B      CM",
        "BB   BB        B                M                                                                      BB                      CD                   BBBBBBBBBBBB                B   B                          BB       ",
        "B    BB        B                                                                             CMMMMMMMMMMD                                            B      B      BBBB         B   B         CMD           CMMB        ",
        "B    BBMD      B                                                                             BBBBBBBBBBBB                                            B                B             B                          B   4  CM",
        "B  3 BB        B        CD              P             1                                      BBBBBBBBBBBB                                       4    B                B             B      B                   BB       ",
        "BB   BB      CMB                     BMMR            CMD            CMD                      BBBBBB    BB           B                               BB                B             B      B                   B        ",
        ...
        "B    BBBBB                           B                                         B                         1                                                            B                                        B       B",
        "B    BBBBB                           B                                         B                                                                                      B                                            4    ",
        "BS           2     YB                B                B     B         B        B          M                  B                                                       BB          1                                    BB",
        "MMMMMMMMMMMMMR     LR     LMMMMMR    MMMMMMMMR   MMM  MMMMMMMMMM  MMMMMMMMMMM  MM                    LMM     4 M                                 M         M          M        LMMR       MMM        MMM     LMMMMMMMMMM",
        ]
...
gemsVector.append("JetPackOne.png")
