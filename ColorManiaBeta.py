...
level_three = [
        ...
        "X                                                                    B          B                                                        ",
        "X         BB                     1        CMMMMMD                    BB         B   CMMMMMMMMB                                           ",
        "X          B           H                                             B          B            B       H     2                             ",
        "X          B         CMMMMD                                          B          B    H       B    CMMMMMMMMMMD                           ",
        "X          B                                        1                           BMMMMMD      B                                           ",
        "X          B                             CMMMD           CMMMD B               BB            B                                           ",
        "X         BB                                                   B                B            B                                           ",
        ...
        "X                                         2                    B                             B                                   CMMMMMMD",
        "X                               H                              B  H G                        B                                           ",
        "X        1               CMMMMMMMMMMMMD                        B CMMMD      1         3 CMMMDB                                           ",
        "XY   H            CMMMD                              CMMMD     B                             B         1        1      1             F   ",
        "LMMMMMMMMMR                                 LMMMR          LMMMMMMMMMMMMMMMMMR  LMMMMMMMMMMMMR   LMMR    LR     LMMMMMMMMM     MMMMMMMMMR",
        ]
