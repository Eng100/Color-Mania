...
level_four= [
        ...
        "X                                                                           B                              BBBBBB    1                   ",
        "X B                                                                         B                              BBBBBB                        ",
        "X    BBBB                                                                  JB        BBBBBBBB  1           BB      BMMMD                 ",
        "X       B                                                                CMMB        BB     B  B           BB      B                     ",
        "X       B                                                                            BB     B  B           BB  BBBBB                     ",
        "X       B            P                         CMMD            CMD                   BB  B     MMD         BB    BBB             CMMMMMMM",
        "X  B    B           CMMD                                                             BB  B     B           BBBB  BMB                     ",
        "X     BBB                                                                            BB  BBBBBBB        B        B                       ",
        "X       B                                                                    CMD     BB       B         B        B                       ",
        "X       B                                                                            BB       B         BBMMMMMMMMMMMMMMD                ",
        "X       B                                                                            BBBBBBB  BD        BB                               ",
        "X       B                      B                 LMR                                 BB       B         BB                               ",
        "X      BB                      B                                                     BB       B         BB                         CMMMMM",
        "X       B                      B                                                     BB  BBBBBB        CBB       CD                      ",
        "X       B                             1                                                       B         BB                               ",
        "X       B             LMR                                                                     B         BB           CMMD                ",
        "XG      B                            B                                                      3 BG                                        F",
        "LMMMMMMMMMM                            LMR              LMR      LMR           LMMMMMMMMMMMMMMMR       LMMR                       LMMMMMR",
        ]
